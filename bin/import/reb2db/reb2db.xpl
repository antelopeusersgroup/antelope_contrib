...
sub init_globals {
    ...
    $Phase_unpack{"IMS1.0:ARRIVAL:AUTOMATIC"} =
        "A9 x A5 x A12 x A10 x A12 x A8 "
      . "x A5 x A5 x A5 x A9 x A5 x A5 x A5 x A9 x A8";
    $Phase_names{"IMS1.0:ARRIVAL:AUTOMATIC"} = [
        "ph_net",      "ph_sta",
        "ph_beamid",   "ph_date",
        "ph_time",     "ph_code",
        "ph_az",       "ph_slow",
        "ph_snr",      "ph_amp_nm",
        "ph_per",      "ph_short_time_average",
        "ph_duration", "ph_auth",
        "ph_arid"
    ];
    ...
    $Event_names{"IMS1.0-line1"} = [
        ...
        "or_nearest",  "or_furthest",  "or_antype",   "or_locmeth",
        "or_evtype",   "or_auth",      "orid"
    ];
    ...
    $Event_names{"GSE2.0-line1"} = [
        ...
        "or_magtype3", "or_mag3",      "or_magnsta3", "or_auth",
        "orid"
    ];
    ...
    $Event_names{"GSE2.0-line2"} = [
        "or_rms",     "or_timeerr",  "or_smaj",    "or_smin",
        "or_strike",  "or_deptherr", "or_nearest", "or_furthest",
        "or_mag1err", "or_mag2err",  "or_mag3err", "or_antype",
        "or_locmeth", "or_evtype"
    ];
    ...
    $Phase_names{"IMS1.0"} = [
        ...
        "ph_slow",    "ph_slowres", "ph_timedef", "ph_azdef",
        "ph_slowdef", "ph_snr",     "ph_amp_nm",  "ph_per",
        "ph_type",    "ph_fm",      "ph_qual",    "ph_magtype",
    ...
    $Phase_names{"GSE2.0"} = [
        "ph_sta",     "ph_delta",    "ph_esaz",  "ph_type",
        "ph_fm",      "ph_qual",     "ph_code",  "ph_arrtime",
        "ph_timeres", "ph_az",       "ph_azres", "ph_slow",
        "ph_slowres", "ph_timedef",  "ph_azdef", "ph_slowdef",
        "ph_snr",     "ph_amp_nm",   "ph_per",   "ph_magtype1",
