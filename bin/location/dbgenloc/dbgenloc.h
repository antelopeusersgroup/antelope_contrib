...
extern int load_observations PL_(( Pf *pf, Dbptr db, Arr *arr_phase, Arr **stationsp, 
...
extern int save_results PL_(( Dbptr dbin, Dbptr dbout, Pf *pf, 
	Tbl *ta, Tbl *tu, Tbl *taro, Tbl *turo,	
	Location_options *o, char *vmodel, 
	Hypocenter *hypo, Tbl *residual, int *oridp,
