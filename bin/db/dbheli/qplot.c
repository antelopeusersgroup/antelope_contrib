...
QPlot *
qpbin (double ts, double dt, int nsamp, float *data, double tmin, double twin, int npixels, QPlot *qpl)
...
int
qpfreeoverlaps (QPlot *qpl)

{
	int i;

	if (!qpl) return(0);
	if (!qpl->overlaps) return(0);
...
int
qplot (double ts, double dt, int nsamp, float *data, double tmin, double twin, int npixels, int x, int y, int h, float *ybot, float *ytop, 
...
int
qplotsegs (QPlot *qpl, int x, int y, int h, float *ybot, float *ytop, int scale_type, float ygain, Display *display, Drawable drawable, GC gc, GC gcov)
...
int
nqplotsegs (QPlot *qpl, float xdim, float ydim, float xlow, float ylow, float *ybot, float *ytop, int scale_type, int iclip, float ygain)
