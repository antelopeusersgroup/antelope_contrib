...
dlat = pfget_num( pf, 'dlat' );
dlon = pfget_num( pf, 'dlon' );
...
[xi, yi] = meshgrid( lonmin:dlon:lonmax, latmin:dlat:latmax );
...
dbaddv( dbqgrid, 'gridname', 'pga', ...
		 ...
		 'lonc', lonc, ...
		 'strike', 0, ...
		 'nx', length( lonmin:dlon:lonmax ), ...
		 'ny', length( latmin:dlat:latmax ), ...
		 'dx', dlon * 111.195, ...
		 'dy', dlat * 111.195, ...
		 'qgridfmt', qgridfmt, ...
		 'orid', orid, ...
