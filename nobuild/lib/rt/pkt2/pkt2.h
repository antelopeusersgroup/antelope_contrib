...
#ifndef pkt2_h_included
#define pkt2_h_included
#include <fcntl.h>
#include <malloc.h>
#include <sys/types.h>
...
#define DAAB   0xDAAB                  /* new_BBA data packets                 */
#define DABC   0xDABC                  /* new_BBA DAS status packets           */
#define DACD   0xDACD                  /* new_BBA DC status packets            */
#define DADE   0xDADE                  /* new_BBA RTX status packets           */
...
extern void     init_StaName (void);
extern void     init_StaCh (void);
extern void     init_StaID (void);
extern void     init_DasID (void);
extern void     init_DcID (void);
extern void     init_RTXID (void);
...
extern char     *get_chname_from_id(ushort_t pkttype, char *ptype, int staid, int chid);
extern int      get_sta_name(void);
...
extern int      parse_newbba(uchar_t * packet, ushort_t pkttype);
...
extern int      read_newbba_DAS (double time, char *srcid, uchar_t * packet, Packet ** Pkt, void *par);
extern int      read_DP (double time, char *srcid, uchar_t * packet, Packet ** Pkt, void *par);
extern int      read_newbba_DP (double time, char *srcid, uchar_t * packet, Packet ** Pkt, void *par);
