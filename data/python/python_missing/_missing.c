...
static PyObject *python_wfchanid(PyObject * self, PyObject * args);
static PyObject *python_arrchanid(PyObject * self, PyObject * args);
...
static struct PyMethodDef _missing_methods[] = {
	{"_wfchanid", python_wfchanid, METH_VARARGS,
	 "get chanid for wfdisc record"},
	{"_arrchanid", python_arrchanid, METH_VARARGS,
	 "get chanid for arrival record "},
...
static PyObject *python_wfchanid(PyObject *self, PyObject *args) {
	char           *usage = "Usage: chanid = _missing._wfchanid( db )\n";
	PyObject       *obj;
	...
	chanid = wfchanid(db);
	obj = Py_BuildValue("l", chanid);
	return obj;
}

static PyObject *python_arrchanid(PyObject *self, PyObject *args) {
	char           *usage = "Usage: chanid = _missing._arrchanid( db )\n";
	PyObject       *obj;
...
static PyObject *python_dbget_calib(PyObject *self, PyObject *args) {
	char           *usage =
		"Usage: _missing._dbget_calib( sta, chan, time, dbname )\n";
	PyObject       *obj;
	char           *sta;
	char           *chan;
	double          time;
...
static PyObject *python_SAMP2TIME(PyObject *self, PyObject *args) {
	char           *usage =
		"Usage: _missing._SAMP2TIME(starttime, samprate, nsamp)\n";
	PyObject       *obj;
	double          starttime, endtime;
	double          samprate;
	long            nsamp;
...
static PyObject *python_SAMPRATE(PyObject *self, PyObject *args) {
	char           *usage =
		"Usage: _missing._SAMPRATE( starttime, nsamp, endtime )\n";
	PyObject       *obj;
	double          starttime, endtime;
	double          samprate;
	long            nsamp;
...
static PyObject *python_NSAMP(PyObject *self, PyObject *args) {
	char           *usage =
		"Usage: _missing._NSAMP( starttime, samprate, endtime )\n";
	PyObject       *obj;
	double          starttime, endtime;
	double          samprate;
	long            nsamp;
...
static PyObject *python_ENDTIME(PyObject *self, PyObject *args) {
	char           *usage =
		"Usage: _missing._ENDTIME( starttime, samprate, nsamp )\n";
	PyObject       *obj;
	double          starttime, endtime;
	double          samprate;
	long            nsamp;
