...
#include "ensemble.h"
namespace SEISPP {
static const string moveout_keyword("moveout"); //Extract moveout from metadata using this keyword
static const string coherence_keyword("coherence"); // key for storing coherence
static const string amplitude_static_keyword("amplitude_static");
static const string stack_weight_keyword("stack_weight");
enum StackType {BasicStack, MedianStack, RobustSNR};
static const double MoveoutBad=1.0e10;
static const double MoveoutBadTest=1.0e8; // Intentionally much smaller as a safe float test
