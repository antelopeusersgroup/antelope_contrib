...
/*           Compute column K of the inverse. */
		...
		i__2 = a_subscr(k, k);
		i__3 = k - 1;
		cdotc_(&q__2, &i__3, &work[1], &c__1, &a_ref(1, k), &c__1);
		r__1 = q__2.r;
...
/*           Compute columns K and K+1 of the inverse. */
		...
		i__2 = a_subscr(k, k + 1);
		i__3 = k - 1;
		cdotc_(&q__2, &i__3, &a_ref(1, k), &c__1, &a_ref(1, k + 1), &
			c__1);
		...
		i__3 = k - 1;
		cdotc_(&q__2, &i__3, &work[1], &c__1, &a_ref(1, k + 1), &c__1)
			;
		r__1 = q__2.r;
		q__1.r = a[i__2].r - r__1, q__1.i = a[i__2].i;
		a[i__1].r = q__1.r, a[i__1].i = q__1.i;
...
/*           Compute column K of the inverse. */
		...
		i__1 = *n - k;
		q__1.r = -1.f, q__1.i = 0.f;
		chemv_(uplo, &i__1, &q__1, &a_ref(k + 1, k + 1), lda, &work[1]
			, &c__1, &c_b2, &a_ref(k + 1, k), &c__1);
		i__1 = a_subscr(k, k);
		i__2 = a_subscr(k, k);
		i__3 = *n - k;
		cdotc_(&q__2, &i__3, &work[1], &c__1, &a_ref(k + 1, k), &c__1)
			;
		r__1 = q__2.r;
		q__1.r = a[i__2].r - r__1, q__1.i = a[i__2].i;
		a[i__1].r = q__1.r, a[i__1].i = q__1.i;
...
/*           Compute columns K-1 and K of the inverse. */
		...
		i__2 = a_subscr(k, k - 1);
		i__3 = *n - k;
		cdotc_(&q__2, &i__3, &a_ref(k + 1, k), &c__1, &a_ref(k + 1, k 
			- 1), &c__1);
		q__1.r = a[i__2].r - q__2.r, q__1.i = a[i__2].i - q__2.i;
		a[i__1].r = q__1.r, a[i__1].i = q__1.i;
		i__1 = *n - k;
		...
		i__2 = a_subscr(k - 1, k - 1);
		i__3 = *n - k;
		cdotc_(&q__2, &i__3, &work[1], &c__1, &a_ref(k + 1, k - 1), &
			c__1);
		r__1 = q__2.r;
		q__1.r = a[i__2].r - r__1, q__1.i = a[i__2].i;
		a[i__1].r = q__1.r, a[i__1].i = q__1.i;
