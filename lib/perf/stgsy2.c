...
/*  -- LAPACK auxiliary routine (version 3.0) --   
    ...
    static real alpha, z__[64]	/* was [8][8] */;
...
/*                 Solve Z * x = RHS */
			...
			*info = ierr;
			...
			if (scaloc != 1.f) {
			    i__2 = *n;
			    for (k = 1; k <= i__2; ++k) {
				sscal_(m, &scaloc, &c___ref(1, k), &c__1);
				sscal_(m, &scaloc, &f_ref(1, k), &c__1);
/* L50: */
			    }
			    *scale *= scaloc;
			}
...
/*                 Substitute R(I, J) and L(I, J) into remaining   
			...
			alpha = -rhs[0];
			i__2 = is - 1;
			saxpy_(&i__2, &alpha, &a_ref(1, is), &c__1, &c___ref(
				1, js), &c__1);
			i__2 = is - 1;
			saxpy_(&i__2, &alpha, &d___ref(1, is), &c__1, &f_ref(
				1, js), &c__1);
		    }
		    if (j < q) {
			i__2 = *n - je;
			saxpy_(&i__2, &rhs[1], &b_ref(js, je + 1), ldb, &
				c___ref(is, je + 1), ldc);
			i__2 = *n - je;
			saxpy_(&i__2, &rhs[1], &e_ref(js, je + 1), lde, &
				f_ref(is, je + 1), ldf);
		    }
...
/*                 Substitute R(I, J) and L(I, J) into remaining   
		    ...
		    if (i__ > 1) {
			i__2 = is - 1;
			sger_(&i__2, &nb, &c_b27, &a_ref(1, is), &c__1, rhs, &
				c__1, &c___ref(1, js), ldc);
			i__2 = is - 1;
			sger_(&i__2, &nb, &c_b27, &d___ref(1, is), &c__1, rhs,
				 &c__1, &f_ref(1, js), ldf);
		    }
		    if (j < q) {
			i__2 = *n - je;
			saxpy_(&i__2, &rhs[2], &b_ref(js, je + 1), ldb, &
				c___ref(is, je + 1), ldc);
			i__2 = *n - je;
			saxpy_(&i__2, &rhs[2], &e_ref(js, je + 1), lde, &
				f_ref(is, je + 1), ldf);
			i__2 = *n - je;
			saxpy_(&i__2, &rhs[3], &b_ref(jsp1, je + 1), ldb, &
				c___ref(is, je + 1), ldc);
			i__2 = *n - je;
			saxpy_(&i__2, &rhs[3], &e_ref(jsp1, je + 1), lde, &
				f_ref(is, je + 1), ldf);
		    }
...
/*                 Substitute R(I, J) and L(I, J) into remaining   
		    ...
		    if (i__ > 1) {
			i__2 = is - 1;
			sgemv_("N", &i__2, &mb, &c_b27, &a_ref(1, is), lda, 
				rhs, &c__1, &c_b42, &c___ref(1, js), &c__1);
			i__2 = is - 1;
			sgemv_("N", &i__2, &mb, &c_b27, &d___ref(1, is), ldd, 
				rhs, &c__1, &c_b42, &f_ref(1, js), &c__1);
		    }
		    if (j < q) {
			i__2 = *n - je;
			sger_(&mb, &i__2, &c_b42, &rhs[2], &c__1, &b_ref(js, 
				je + 1), ldb, &c___ref(is, je + 1), ldc);
			i__2 = *n - je;
			sger_(&mb, &i__2, &c_b42, &rhs[2], &c__1, &e_ref(js, 
...
/*                 Set up right hand side(s) */
		    ...
		    i__2 = nb - 1;
		    for (jj = 0; jj <= i__2; ++jj) {
			scopy_(&mb, &c___ref(is, js + jj), &c__1, &rhs[k - 1],
				 &c__1);
			scopy_(&mb, &f_ref(is, js + jj), &c__1, &rhs[ii - 1], 
				&c__1);
			k += mb;
			ii += mb;
/* L80: */
...
/*                 Unpack solution vector(s) */
		    ...
		    i__2 = nb - 1;
		    for (jj = 0; jj <= i__2; ++jj) {
			scopy_(&mb, &rhs[k - 1], &c__1, &c___ref(is, js + jj),
				 &c__1);
			scopy_(&mb, &rhs[ii - 1], &c__1, &f_ref(is, js + jj), 
				&c__1);
			k += mb;
			ii += mb;
/* L100: */
...
/*                 Substitute R(I, J) and L(I, J) into remaining   
		    ...
		    if (i__ > 1) {
			i__2 = is - 1;
			sgemm_("N", "N", &i__2, &nb, &mb, &c_b27, &a_ref(1, 
				is), lda, rhs, &mb, &c_b42, &c___ref(1, js), 
				ldc);
			i__2 = is - 1;
			sgemm_("N", "N", &i__2, &nb, &mb, &c_b27, &d___ref(1, 
...
/*                 Substitute R(I, J) and L(I, J) into remaining   
			...
			alpha = rhs[0];
			i__3 = js - 1;
			saxpy_(&i__3, &alpha, &b_ref(1, js), &c__1, &f_ref(is,
				 1), ldf);
			alpha = rhs[1];
			i__3 = js - 1;
			saxpy_(&i__3, &alpha, &e_ref(1, js), &c__1, &f_ref(is,
				 1), ldf);
		    }
		    if (i__ < p) {
			alpha = -rhs[0];
			i__3 = *m - ie;
			saxpy_(&i__3, &alpha, &a_ref(is, ie + 1), lda, &
				c___ref(ie + 1, js), &c__1);
			alpha = -rhs[1];
			i__3 = *m - ie;
			saxpy_(&i__3, &alpha, &d___ref(is, ie + 1), ldd, &
				c___ref(ie + 1, js), &c__1);
		    }
...
/*                 Substitute R(I, J) and L(I, J) into remaining   
		    ...
		    if (j > p + 2) {
			i__3 = js - 1;
			saxpy_(&i__3, rhs, &b_ref(1, js), &c__1, &f_ref(is, 1)
				, ldf);
			i__3 = js - 1;
			saxpy_(&i__3, &rhs[1], &b_ref(1, jsp1), &c__1, &f_ref(
				is, 1), ldf);
			i__3 = js - 1;
			saxpy_(&i__3, &rhs[2], &e_ref(1, js), &c__1, &f_ref(
				is, 1), ldf);
			i__3 = js - 1;
			saxpy_(&i__3, &rhs[3], &e_ref(1, jsp1), &c__1, &f_ref(
				is, 1), ldf);
		    }
		    if (i__ < p) {
			i__3 = *m - ie;
			sger_(&i__3, &nb, &c_b27, &a_ref(is, ie + 1), lda, 
				rhs, &c__1, &c___ref(ie + 1, js), ldc);
			i__3 = *m - ie;
			sger_(&i__3, &nb, &c_b27, &d___ref(is, ie + 1), ldd, &
...
/*                 Substitute R(I, J) and L(I, J) into remaining   
		    ...
		    if (j > p + 2) {
			i__3 = js - 1;
			sger_(&mb, &i__3, &c_b42, rhs, &c__1, &b_ref(1, js), &
				c__1, &f_ref(is, 1), ldf);
			i__3 = js - 1;
			sger_(&mb, &i__3, &c_b42, &rhs[2], &c__1, &e_ref(1, 
				js), &c__1, &f_ref(is, 1), ldf);
		    }
		    if (i__ < p) {
			i__3 = *m - ie;
			sgemv_("T", &mb, &i__3, &c_b27, &a_ref(is, ie + 1), 
				lda, rhs, &c__1, &c_b42, &c___ref(ie + 1, js),
				 &c__1);
			i__3 = *m - ie;
			sgemv_("T", &mb, &i__3, &c_b27, &d___ref(is, ie + 1), 
...
/*                 Substitute R(I, J) and L(I, J) into remaining   
		    ...
		    if (j > p + 2) {
			i__3 = js - 1;
			sgemm_("N", "T", &mb, &i__3, &nb, &c_b42, &c___ref(is,
				 js), ldc, &b_ref(1, js), ldb, &c_b42, &f_ref(
				is, 1), ldf);
			i__3 = js - 1;
			sgemm_("N", "T", &mb, &i__3, &nb, &c_b42, &f_ref(is, 
				js), ldf, &e_ref(1, js), lde, &c_b42, &f_ref(
				is, 1), ldf);
		    }
		    if (i__ < p) {
			i__3 = *m - ie;
			sgemm_("T", "N", &i__3, &nb, &mb, &c_b27, &a_ref(is, 
				ie + 1), lda, &c___ref(is, js), ldc, &c_b42, &
				c___ref(ie + 1, js), ldc);
			i__3 = *m - ie;
			sgemm_("T", "N", &i__3, &nb, &mb, &c_b27, &d___ref(is,
