...
/*           Update the unreduced submatrix A(1:i-1,1:i-1), using an   
	    ...
	    cher2k_(uplo, "No transpose", &i__3, &nb, &q__1, &a_ref(1, i__), 
...
/*           Reduce columns i:i+nb-1 to tridiagonal form and form the   
	    ...
	    i__3 = *n - i__ + 1;
	    clatrd_(uplo, &i__3, &nb, &a_ref(i__, i__), lda, &e[i__], &tau[
		    i__], &work[1], &ldwork);
...
/*           Update the unreduced submatrix A(i+nb:n,i+nb:n), using   
	    ...
	    i__3 = *n - i__ - nb + 1;
	    q__1.r = -1.f, q__1.i = 0.f;
	    cher2k_(uplo, "No transpose", &i__3, &nb, &q__1, &a_ref(i__ + nb, 
...
/*        Use unblocked code to reduce the last or only block */
	...
	i__1 = *n - i__ + 1;
	chetd2_(uplo, &i__1, &a_ref(i__, i__), lda, &d__[i__], &e[i__], &tau[
		i__], &iinfo);
    }
