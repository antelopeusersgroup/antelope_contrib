...
/*        IC : center row of each node   
	...
	nlf = ic - nl;
	nrf = ic + 1;
	sgemm_("T", "N", &nl, nrhs, &nl, &c_b7, &u_ref(nlf, 1), ldu, &b_ref(
		nlf, 1), ldb, &c_b8, &bx_ref(nlf, 1), ldbx);
	sgemm_("T", "N", &nr, nrhs, &nr, &c_b7, &u_ref(nrf, 1), ldu, &b_ref(
...
/*     The nodes on the bottom level of the tree were solved   
	...
	nlf = ic - nl;
	nrf = ic + 1;
	sgemm_("T", "N", &nlp1, nrhs, &nlp1, &c_b7, &vt_ref(nlf, 1), ldu, &
		b_ref(nlf, 1), ldb, &c_b8, &bx_ref(nlf, 1), ldbx);
	sgemm_("T", "N", &nrp1, nrhs, &nrp1, &c_b7, &vt_ref(nrf, 1), ldu, &
