...
/*  -- LAPACK routine (version 3.0) --   
    ...
    static real tmpii, c1, c2;
    static integer lwmin;
    static logical wants;
    static real tmpir;
    static integer n1, n2;
    static real tmpri, dummy[1], tmprr;
    extern doublereal slapy2_(real *, real *);
    static real dummy1[1];
    static integer ks;
    static real alphai;
    static integer iz;
    static real alphar;
...
/*              Complex eigenvalue pair. */
		...
		sgemv_("N", n, n, &c_b19, &a[a_offset], lda, &vr_ref(1, ks), &
			c__1, &c_b21, &work[1], &c__1);
		tmprr = sdot_(n, &work[1], &c__1, &vl_ref(1, ks), &c__1);
		tmpri = sdot_(n, &work[1], &c__1, &vl_ref(1, ks + 1), &c__1);
		sgemv_("N", n, n, &c_b19, &a[a_offset], lda, &vr_ref(1, ks + 
			1), &c__1, &c_b21, &work[1], &c__1);
		tmpii = sdot_(n, &work[1], &c__1, &vl_ref(1, ks + 1), &c__1);
		tmpir = sdot_(n, &work[1], &c__1, &vl_ref(1, ks), &c__1);
		uhav = tmprr + tmpii;
		uhavi = tmpir - tmpri;
		sgemv_("N", n, n, &c_b19, &b[b_offset], ldb, &vr_ref(1, ks), &
			c__1, &c_b21, &work[1], &c__1);
		tmprr = sdot_(n, &work[1], &c__1, &vl_ref(1, ks), &c__1);
		tmpri = sdot_(n, &work[1], &c__1, &vl_ref(1, ks + 1), &c__1);
		sgemv_("N", n, n, &c_b19, &b[b_offset], ldb, &vr_ref(1, ks + 
...
/*              Real eigenvalue. */
		...
		sgemv_("N", n, n, &c_b19, &a[a_offset], lda, &vr_ref(1, ks), &
			c__1, &c_b21, &work[1], &c__1);
		uhav = sdot_(n, &work[1], &c__1, &vl_ref(1, ks), &c__1);
		sgemv_("N", n, n, &c_b19, &b[b_offset], ldb, &vr_ref(1, ks), &
			c__1, &c_b21, &work[1], &c__1);
		uhbv = sdot_(n, &work[1], &c__1, &vl_ref(1, ks), &c__1);
		cond = slapy2_(&uhav, &uhbv);
		if (cond == 0.f) {
		    s[ks] = -1.f;
		} else {
	...
	if (wantdf) {
	    if (*n == 1) {
		dif[ks] = slapy2_(&a_ref(1, 1), &b_ref(1, 1));
		goto L20;
	    }
