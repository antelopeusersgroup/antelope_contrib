...
/*           Compute elements j-km:j-1 of the j-th column and update the   
	    ...
	    d__1 = 1. / ajj;
	    zdscal_(&km, &d__1, &ab_ref(*kd + 1 - km, j), &c__1);
	    zher_("Upper", &km, &c_b9, &ab_ref(*kd + 1 - km, j), &c__1, &
...
/*           Compute elements j+1:j+km of the j-th row and update the   
	    ...
	    if (km > 0) {
		d__1 = 1. / ajj;
		zdscal_(&km, &d__1, &ab_ref(*kd, j + 1), &kld);
		zlacgv_(&km, &ab_ref(*kd, j + 1), &kld);
		zher_("Upper", &km, &c_b9, &ab_ref(*kd, j + 1), &kld, &ab_ref(
			*kd + 1, j + 1), &kld);
		zlacgv_(&km, &ab_ref(*kd, j + 1), &kld);
	    }
/* L20: */
...
/*           Compute elements j-km:j-1 of the j-th row and update the   
	    ...
	    d__1 = 1. / ajj;
	    zdscal_(&km, &d__1, &ab_ref(km + 1, j - km), &kld);
	    zlacgv_(&km, &ab_ref(km + 1, j - km), &kld);
	    zher_("Lower", &km, &c_b9, &ab_ref(km + 1, j - km), &kld, &ab_ref(
		    1, j - km), &kld);
	    zlacgv_(&km, &ab_ref(km + 1, j - km), &kld);
/* L30: */
	}
...
/*           Compute elements j+1:j+km of the j-th column and update the   
	    ...
	    if (km > 0) {
		d__1 = 1. / ajj;
		zdscal_(&km, &d__1, &ab_ref(2, j), &c__1);
		zher_("Lower", &km, &c_b9, &ab_ref(2, j), &c__1, &ab_ref(1, j 
			+ 1), &kld);
	    }
/* L40: */
	}
