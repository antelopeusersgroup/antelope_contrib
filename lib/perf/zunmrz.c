...
/*  -- LAPACK routine (version 3.0) --   
    ...
    static integer nbmin, iinfo, i1, i2, i3, ib, ic, ja, jc, nb, mi, ni;
...
/*           Form the triangular factor of the block reflector   
	    ...
	    zlarzt_("Backward", "Rowwise", l, &ib, &a_ref(i__, ja), lda, &tau[
		    i__], t, &c__65);
...
/*           Apply H or H' */
	    ...
	    zlarzb_(side, transt, "Backward", "Rowwise", &mi, &ni, &ib, l, &
		    a_ref(i__, ja), lda, t, &c__65, &c___ref(ic, jc), ldc, &
		    work[1], &ldwork);
/* L10: */
	}
