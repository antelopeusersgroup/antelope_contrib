	 ...
	 real *work, integer *lwork, integer *iwork, integer *info)
{
    ...
    static integer ie, il, ir, bdspac, iu;
...
/*              Zero out below R */
		...
		i__1 = *n - 1;
		i__2 = *n - 1;
		slaset_("L", &i__1, &i__2, &c_b227, &c_b227, &a_ref(2, 1), 
			lda);
		ie = 1;
		itauq = ie + *n;
		itaup = itauq + *n;
...
/* Computing MIN */
		    ...
		    sgemm_("N", "N", &chunk, n, n, &c_b248, &a_ref(i__, 1), 
...
/*              Produce R in A, zeroing out other entries */
		...
		i__2 = *n - 1;
		i__1 = *n - 1;
		slaset_("L", &i__2, &i__1, &c_b227, &c_b227, &a_ref(2, 1), 
			lda);
		ie = itau;
		itauq = ie + *n;
		itaup = itauq + *n;
...
/*              Set the right corner of U to identity matrix */
		...
		i__1 = *m - *n;
		i__2 = *m - *n;
		slaset_("F", &i__1, &i__2, &c_b227, &c_b248, &u_ref(*n + 1, *
			n + 1), ldu);
...
/*              Zero out above L */
		...
		i__1 = *m - 1;
		i__2 = *m - 1;
		slaset_("U", &i__1, &i__2, &c_b227, &c_b227, &a_ref(1, 2), 
			lda);
		ie = 1;
		itauq = ie + *m;
		itaup = itauq + *m;
...
/* Computing MIN */
		    i__3 = *n - i__ + 1;
		    blk = min(i__3,chunk);
		    sgemm_("N", "N", m, &blk, m, &c_b248, &work[ivt], m, &
...
/*              Produce L in A, zeroing out other entries */
		...
		i__2 = *m - 1;
		i__1 = *m - 1;
		slaset_("U", &i__2, &i__1, &c_b227, &c_b227, &a_ref(1, 2), 
			lda);
		ie = itau;
		itauq = ie + *m;
		itaup = itauq + *m;
...
/*              Set the right corner of VT to identity matrix */
		...
		i__1 = *n - *m;
		i__2 = *n - *m;
		slaset_("F", &i__1, &i__2, &c_b227, &c_b248, &vt_ref(*m + 1, *
			m + 1), ldvt);
