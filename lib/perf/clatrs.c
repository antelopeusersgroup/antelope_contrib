...
/*           A is upper triangular. */
	    ...
	    for (j = 1; j <= i__1; ++j) {
		i__2 = j - 1;
		cnorm[j] = scasum_(&i__2, &a_ref(1, j), &c__1);
/* L10: */
	    }
	} else {
...
/*           A is lower triangular. */
	    ...
	    for (j = 1; j <= i__1; ++j) {
		i__2 = *n - j;
		cnorm[j] = scasum_(&i__2, &a_ref(j + 1, j), &c__1);
/* L20: */
	    }
	    cnorm[*n] = 0.f;
	}
...
/*                    Compute the update   
			...
			caxpy_(&i__3, &q__1, &a_ref(1, j), &c__1, &x[1], &
				c__1);
			i__3 = j - 1;
...
/*                    Compute the update   
			...
			q__2.r = -x[i__4].r, q__2.i = -x[i__4].i;
			q__1.r = tscal * q__2.r, q__1.i = tscal * q__2.i;
			caxpy_(&i__3, &q__1, &a_ref(j + 1, j), &c__1, &x[j + 
				1], &c__1);
			i__3 = *n - j;
...
/*                 If the scaling needed for A in the dot product is 1,   
		    ...
		    if (upper) {
			i__3 = j - 1;
			cdotu_(&q__1, &i__3, &a_ref(1, j), &c__1, &x[1], &
				c__1);
			csumj.r = q__1.r, csumj.i = q__1.i;
		    } else if (j < *n) {
			i__3 = *n - j;
			cdotu_(&q__1, &i__3, &a_ref(j + 1, j), &c__1, &x[j + 
				1], &c__1);
			csumj.r = q__1.r, csumj.i = q__1.i;
		    }
		} else {
...
/*                 If the scaling needed for A in the dot product is 1,   
		    ...
		    if (upper) {
			i__3 = j - 1;
			cdotc_(&q__1, &i__3, &a_ref(1, j), &c__1, &x[1], &
				c__1);
			csumj.r = q__1.r, csumj.i = q__1.i;
		    } else if (j < *n) {
			i__3 = *n - j;
			cdotc_(&q__1, &i__3, &a_ref(j + 1, j), &c__1, &x[j + 
				1], &c__1);
			csumj.r = q__1.r, csumj.i = q__1.i;
		    }
		} else {
