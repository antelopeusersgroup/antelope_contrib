...
/* L20: */
		...
		for (j = *n; j >= 1; --j) {
			...
			if (nounit) {
			    i__1 = jx;
			    z_div(&z__1, &x[jx], &a_ref(kplus1, j));
			    x[i__1].r = z__1.r, x[i__1].i = z__1.i;
			}
			i__1 = jx;
			temp.r = x[i__1].r, temp.i = x[i__1].i;
...
/* L90: */
			...
			if (nounit) {
			    z_div(&z__1, &temp, &a_ref(kplus1, j));
			    temp.r = z__1.r, temp.i = z__1.i;
			}
		    } else {
/* Computing MAX */
