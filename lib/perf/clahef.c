...
/*        Copy column K of A to column KW of W and update it */
	...
	i__1 = k - 1;
	ccopy_(&i__1, &a_ref(1, k), &c__1, &w_ref(1, kw), &c__1);
	i__1 = w_subscr(k, kw);
	i__2 = a_subscr(k, k);
	r__1 = a[i__2].r;
...
/*              Copy column IMAX to column KW-1 of W and update it */
		...
		i__1 = imax - 1;
		ccopy_(&i__1, &a_ref(1, imax), &c__1, &w_ref(1, kw - 1), &
			c__1);
		...
		ccopy_(&i__1, &a_ref(imax, imax + 1), lda, &w_ref(imax + 1, 
			kw - 1), &c__1);
		i__1 = k - imax;
		clacgv_(&i__1, &w_ref(imax + 1, kw - 1), &c__1);
		if (k < *n) {
		    i__1 = *n - k;
		    q__1.r = -1.f, q__1.i = 0.f;
...
/*              Copy non-updated column KK to column KP */
		...
		ccopy_(&i__1, &a_ref(kp + 1, kk), &c__1, &a_ref(kp, kp + 1), 
			lda);
		i__1 = kk - 1 - kp;
		clacgv_(&i__1, &a_ref(kp, kp + 1), lda);
		i__1 = kp - 1;
		ccopy_(&i__1, &a_ref(1, kk), &c__1, &a_ref(1, kp), &c__1);

/*              Interchange rows KK and KP in last KK columns of A and W */

		if (kk < *n) {
		    i__1 = *n - kk;
		    cswap_(&i__1, &a_ref(kk, kk + 1), lda, &a_ref(kp, kk + 1),
			     lda);
		}
		i__1 = *n - kk + 1;
...
/*              Conjugate W(k) and W(k-1) */
		...
		clacgv_(&i__1, &w_ref(1, kw), &c__1);
		i__1 = k - 2;
		clacgv_(&i__1, &w_ref(1, kw - 1), &c__1);
	    }
	}
...
/*        Copy column K of A to column K of W and update it */
	...
	if (k < *n) {
	    i__1 = *n - k;
	    ccopy_(&i__1, &a_ref(k + 1, k), &c__1, &w_ref(k + 1, k), &c__1);
	}
	i__1 = *n - k + 1;
	i__2 = k - 1;
	q__1.r = -1.f, q__1.i = 0.f;
...
/*              Copy column IMAX to column K+1 of W and update it */
		...
		if (imax < *n) {
		    i__1 = *n - imax;
		    ccopy_(&i__1, &a_ref(imax + 1, imax), &c__1, &w_ref(imax 
			    + 1, k + 1), &c__1);
		}
		i__1 = *n - k + 1;
		i__2 = k - 1;
...
/*              Copy non-updated column KK to column KP */
		...
		a[i__1].r = r__1, a[i__1].i = 0.f;
		i__1 = kp - kk - 1;
		ccopy_(&i__1, &a_ref(kk + 1, kk), &c__1, &a_ref(kp, kk + 1), 
			lda);
		i__1 = kp - kk - 1;
		clacgv_(&i__1, &a_ref(kp, kk + 1), lda);
		if (kp < *n) {
		    i__1 = *n - kp;
		    ccopy_(&i__1, &a_ref(kp + 1, kk), &c__1, &a_ref(kp + 1, 
			    kp), &c__1);
		}
...
/*              Interchange rows KK and KP in first KK columns of A and W */
		...
		i__1 = kk - 1;
		cswap_(&i__1, &a_ref(kk, 1), lda, &a_ref(kp, 1), lda);
...
/*              Conjugate W(k) and W(k+1) */
		...
		clacgv_(&i__1, &w_ref(k + 1, k), &c__1);
		i__1 = *n - k - 1;
		clacgv_(&i__1, &w_ref(k + 2, k + 1), &c__1);
	    }
	}
