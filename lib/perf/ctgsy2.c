...
/*              Build 2 by 2 system */
		...
		i__2 = z___subscr(1, 2);
		i__3 = b_subscr(j, j);
		q__1.r = -b[i__3].r, q__1.i = -b[i__3].i;
		z__[i__2].r = q__1.r, z__[i__2].i = q__1.i;
		i__2 = z___subscr(2, 2);
		i__3 = e_subscr(j, j);
		q__1.r = -e[i__3].r, q__1.i = -e[i__3].i;
		z__[i__2].r = q__1.r, z__[i__2].i = q__1.i;
...
/*              Substitute R(I, J) and L(I, J) into remaining equation. */
		...
		if (i__ > 1) {
		    ...
		    i__2 = i__ - 1;
		    caxpy_(&i__2, &alpha, &a_ref(1, i__), &c__1, &c___ref(1, 
			    j), &c__1);
		    i__2 = i__ - 1;
		    caxpy_(&i__2, &alpha, &d___ref(1, i__), &c__1, &f_ref(1, 
			    j), &c__1);
		}
		if (j < *n) {
		    i__2 = *n - j;
		    caxpy_(&i__2, &rhs[1], &b_ref(j, j + 1), ldb, &c___ref(
			    i__, j + 1), ldc);
		    i__2 = *n - j;
		    caxpy_(&i__2, &rhs[1], &e_ref(j, j + 1), lde, &f_ref(i__, 
			    j + 1), ldf);
		}
...
/*              Build 2 by 2 system Z' */
		...
		z__[i__2].r = q__1.r, z__[i__2].i = q__1.i;
		i__2 = z___subscr(2, 1);
		r_cnjg(&q__2, &b_ref(j, j));
		q__1.r = -q__2.r, q__1.i = -q__2.i;
		z__[i__2].r = q__1.r, z__[i__2].i = q__1.i;
		i__2 = z___subscr(1, 2);
		r_cnjg(&q__1, &d___ref(i__, i__));
		z__[i__2].r = q__1.r, z__[i__2].i = q__1.i;
		i__2 = z___subscr(2, 2);
		r_cnjg(&q__2, &e_ref(j, j));
		q__1.r = -q__2.r, q__1.i = -q__2.i;
		z__[i__2].r = q__1.r, z__[i__2].i = q__1.i;
