...
/*        Reduce rows and columns i:i+ib-1 to bidiagonal form and return   
	...
	i__3 = *m - i__ + 1;
	i__4 = *n - i__ + 1;
	clabrd_(&i__3, &i__4, &nb, &a_ref(i__, i__), lda, &d__[i__], &e[i__], 
...
/*        Update the trailing submatrix A(i+ib:m,i+ib:n), using   
	...
	cgemm_("No transpose", "Conjugate transpose", &i__3, &i__4, &nb, &
		q__1, &a_ref(i__ + nb, i__), lda, &work[ldwrkx * nb + nb + 1],
...
/*     Use unblocked code to reduce the remainder of the matrix */
    ...
    i__2 = *m - i__ + 1;
    i__1 = *n - i__ + 1;
    cgebd2_(&i__2, &i__1, &a_ref(i__, i__), lda, &d__[i__], &e[i__], &tauq[
