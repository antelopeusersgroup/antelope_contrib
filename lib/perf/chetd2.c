...
/*           Generate elementary reflector H(i) = I - tau * v * v'   
	    ...
	    clarfg_(&i__, &alpha, &a_ref(1, i__ + 1), &c__1, &taui);
	    i__1 = i__;
	    e[i__1] = alpha.r;
...
/*              Compute  x := tau * A * v  storing x in TAU(1:i) */
		...
		chemv_(uplo, &i__, &taui, &a[a_offset], lda, &a_ref(1, i__ + 
...
/*              Compute  w := x - 1/2 * tau * (x'*v) * v */
		...
		cdotc_(&q__4, &i__, &tau[1], &c__1, &a_ref(1, i__ + 1), &c__1)
			;
		q__1.r = q__2.r * q__4.r - q__2.i * q__4.i, q__1.i = q__2.r * 
			q__4.i + q__2.i * q__4.r;
		alpha.r = q__1.r, alpha.i = q__1.i;
		caxpy_(&i__, &alpha, &a_ref(1, i__ + 1), &c__1, &tau[1], &
			c__1);
...
/*              Apply the transformation as a rank-2 update:   
		...
		cher2_(uplo, &i__, &q__1, &a_ref(1, i__ + 1), &c__1, &tau[1], 
			&c__1, &a[a_offset], lda);
...
/* Computing MIN */
	    i__2 = i__ + 2;
	    i__3 = *n - i__;
	    clarfg_(&i__3, &alpha, &a_ref(min(i__2,*n), i__), &c__1, &taui);
	    i__2 = i__;
	    e[i__2] = alpha.r;
...
/*              Compute  x := tau * A * v  storing y in TAU(i:n-1) */
		...
		i__2 = *n - i__;
		chemv_(uplo, &i__2, &taui, &a_ref(i__ + 1, i__ + 1), lda, &
...
/*              Compute  w := x - 1/2 * tau * (x'*v) * v */
		...
		q__2.r = q__3.r * taui.r - q__3.i * taui.i, q__2.i = q__3.r * 
			taui.i + q__3.i * taui.r;
		i__2 = *n - i__;
		cdotc_(&q__4, &i__2, &tau[i__], &c__1, &a_ref(i__ + 1, i__), &
			c__1);
		q__1.r = q__2.r * q__4.r - q__2.i * q__4.i, q__1.i = q__2.r * 
			q__4.i + q__2.i * q__4.r;
		alpha.r = q__1.r, alpha.i = q__1.i;
		i__2 = *n - i__;
		caxpy_(&i__2, &alpha, &a_ref(i__ + 1, i__), &c__1, &tau[i__], 
			&c__1);
...
/*              Apply the transformation as a rank-2 update:   
		...
		i__2 = *n - i__;
		q__1.r = -1.f, q__1.i = 0.f;
		cher2_(uplo, &i__2, &q__1, &a_ref(i__ + 1, i__), &c__1, &tau[
